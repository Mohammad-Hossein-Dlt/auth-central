...
from app.src.infra.external_api.service.auth import AuthService

from app.src.infra.external_api.interface.Iprotected_resource import IProtectedResourceService
from app.src.infra.external_api.service.protected_resource import ProtectedResourceService
